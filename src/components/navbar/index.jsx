...
import { LOGIN_TITLE, LOGOUT_TITLE, REGISTRATION_TITLE } from '../../utils/names'
					...
					<Nav className="ms-auto">
						{
							!isAuth ?
								...
								<>
									<div className="btn text-danger ms-auto"
										 onClick={ onLogout }>{ LOGOUT_TITLE }<DoorOpen className="ms-2" size={ 30 }/>
									</div>
								</>
						}
